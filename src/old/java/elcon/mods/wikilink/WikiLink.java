...
import elcon.mods.wikilink.cfg.ConfigHandler;
import elcon.mods.wikilink.net.CommonProxy;
import elcon.mods.wikilink.net.ConnectionHandler;
import elcon.mods.wikilink.plg.PluginManager;
import elcon.mods.wikilink.plg.PluginRegistrar;
import elcon.mods.wikilink.run.bind.WorldInspection;
import elcon.mods.wikilink.util.PacketHandler;
import elcon.mods.wikilink.util.UpdateHandler;
import elcon.mods.wikilink.web.WebHelper;
import elcon.mods.wikilink.web.link.Link;

/**
 * WikiLink<br>
 * Minecraft Modification that bridges the information gap between different wikis and the corresponding mods. <br>
 * Also adds support for various different sources such as YouTube and Google.
 * 
 * @since 8/12/2013
	...
	public void postInit(FMLPostInitializationEvent event) {
		...
		if(ConfigHandler.debugMode) {
			...
			for(String str : tempList)
				WikiLink.LogHelper.warning(String.format("The YouTube link %s is a dead code. Please send a message to " + "@DrEinsteinium to tell him about this.", str));
		}
